package com.creativestudio.inlab.ui.editProfile;
...
import com.creativestudio.inlab.utils.widgets.CustomEditText;
...
public class ActivityProfile extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        batchName.setText(getResources().getString(R.string.Batch) + " : " + modelLogin.getStudentData().getBatchName() + "\n" + modelLogin.getStudentData().getEnrollmentId());
