            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        startActivity(new Intent(paypal.this, ActivityPaymentGateway.class)
                                .putExtra("paymentdata", "" + jsonObject1.getString("id")).putExtra("amount",""+amount).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
