...
public interface AppConsts {
  ...
  String MAIN_URl = "https://inlab.id/admin"; //  put your server base url here thanks..

  String BASE_URL = MAIN_URl + "/api/";

    String URL_PRIVACY_POLICY = "http://kamleshyadav.com/e-academy_app/privacyandpolicy"; // url change here
